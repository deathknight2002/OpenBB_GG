...
async def search(
    ...
    Search for clinical trials by disease indication, intervention type,
    trial phase, status, and other criteria across global trial databases.
    """
...
async def details(
    ...
    Retrieves comprehensive trial information including study design, eligibility,
    endpoints, enrollment, investigators, and outcomes.
    """
    return await OBBject.from_query(Query(**locals()))
